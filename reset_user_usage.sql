-- Script pour réinitialiser l'utilisation d'un utilisateur spécifique

-- Remplacez 'USER_ID_HERE' par l'ID de l'utilisateur que vous voulez réinitialiser
-- Exemple : '123e4567-e89b-12d3-a456-426614174000'

-- 1. Voir l'utilisation actuelle de l'utilisateur
SELECT 
    u.email,
...
-- 2. Supprimer l'utilisation d'aujourd'hui pour cet utilisateur
